              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <ComicInput
                    ...
                    onChange={(e) =>
                      handleInputChange("subjectPerformance", e.target.value)
                    }
                    min="0"
                  />
                ...
                <div>
                  <ComicInput
                    ...
                    onChange={(e) =>
                      handleInputChange("subjectPerformanceMax", e.target.value)
                    }
                    min="1"
                  />
                </div>
        ...
        >
          {prediction ? (
            <>
                  ...
                  >
                    <ComicCard variant="yellow" className="mb-4">
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="font-bangers text-2xl">AI Insights</h3>
                      </div>
              ...
              >
                <ComicCard
                  variant={prediction.passProbability >= 50 ? "green" : "red"}
